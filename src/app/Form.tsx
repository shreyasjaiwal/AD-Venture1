...
const Form = () => {
  ...
  return (
    <div className="w-full pb-16 px-4 py-16 bg-[#0a0b10]" id="form">
      ...
      <p className="text-white text-center">Kindly fill the form according to number of participants, if there is solo participation fill first form and directly fill the drive link of the work</p>
      <div className="flex justify-center">
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col">
              <label htmlFor="website" className="text-gray-500 font-bold mt-14">
                Drive link of your submission
              </label>
              <input
                type="text"
                name="website"
                ...
                onChange={handleChange}
                onBlur={handleBlur}
                className="bg-gray-200 sm:w-[850px] appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white"
              />
              {errors.website && touched.website ? (
                <p className="text-sm text-red-600">{errors.website}</p>
              ) : null}
          ...
          <div className="flex items-center">
            <button
              type="submit"
              className="text-white w-[200px] rounded-md font-medium my-8 mx-auto  py-3 bg-gray-500 hover:scale-105 hover:bg-white hover:text-black  duration-200"
            >
              Submit
            </button>
          </div>
